   ...
   Rectangle { x: 2; y: 149; width: 508; height: 398;	color: "#3a3a3a"; radius: 2
     ...
     Rectangle { id: item; x: 3; y: 3; width: 502; height: 57;	color: "#282828"; radius: 2
       CheckBox { id: primInt; checked: true; x: 3; y: 2;
	      Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "início diferente de unís./8ªJ" }
	      CheckBox { id: ex5Ji; checked: true; x: 20; y: 18;
	        Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 12; text: "exceto 5ªJ, se CF voz inf." } }
	      CheckBox { id: ex3i; checked: true; x: 20; y: 35;
	        Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 12; text: "exceto 3ª, se CF voz inf." } }
	    } // ultimo intervalo
	    CheckBox { id: ultInt; checked: true; x: 260; y: 2;
	      Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "final diferente de unís./8ªJ" }
	  ...
	  Rectangle { id: item1a; x: 3; y: 63; width: 502; height: 47;	color: "#282828"; radius: 2
       CheckBox { id: ultNotas; checked: true; x: 5; y: 3;
	      ...
	      CheckBox { id: quartaJi; checked: true; x: -3; y: 22;
	        Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 12; text: "exceto 4ªJ asc / 5ªJ desc, voz inf." } }
         CheckBox { id: quartaJs; checked: true; x: 240; y: 22;
	        Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 12; text: "exceto 4ªJ asc / 5ªJ desc, voz sup." } }
	    }
	  }
     ...
     // paralelas
	  Rectangle { id: item1; x: 3; y: 113; width: 502; height: 83; color: "#1c1c1c"; radius: 2
	     ...
	     CheckBox { id: paralela8; checked: true; x: 5; y: 3;
	       Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "8ª paralela" }
	     ...
	     CheckBox { id: paralela5; checked: true; x: 5; y: 44;
	       Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "5ª paralela" }
	     ...
	     CheckBox { id: paralela4; checked: false; x: 245; y: 3;
	      Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "4ªJ paralela" }
	     ...
	     CheckBox { id: paralela36; checked: true; x: 245; y: 44;
	      Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "3ª e 6ª paralela" }
	   ...
	   Rectangle { id: item2; x: 3; y: 199; width: 502; height: 50; color: "#1c1c1c"; radius: 2
	     ...
	     CheckBox { id: oculta8; checked: true; x: 5; y: 3;
	       onClicked: {if (!oculta8.checked && !oculta5.checked) { ocultAsc.checked = false; ocultExt.checked = false; ocultSalto.checked = false;}}
	          Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "8ª oculta/direta" }
	      }

	     CheckBox { id: oculta5; checked: true; x: 5; y: 26;
	       onClicked: {if (!oculta8.checked && !oculta5.checked) { ocultAsc.checked = false; ocultExt.checked = false; ocultSalto.checked = false;}}
	          Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "5ª oculta/direta" }
	      }
		 	  CheckBox { id: ocultEx; checked: true; x: 190; y: 6;
		     Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 12; text: "Exceto no final" }
		 		}

		 	  CheckBox { id: ocultSalto; checked: true; x: 190; y: 24;
		     Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 12; text: "Somente se salto na voz superior" }
		 		}
		  }
	   ...
	   Rectangle { id: item3; x: 3; y: 252; width: 267; height: 50;	color: "#1c1c1c"; radius: 2
	     ...
	     CheckBox { id: consecObli; checked: false; x: 5; y: 3;
	        Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "5ª e 8ª consecutivas oblíquo" }
	      }

			CheckBox { id: consecCont; checked: false; x: 5; y: 26;
		     Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "5ª e 8ª consecutivas contrário" }
		 		}
	     ...
	     CheckBox { id: inter8; checked: true; x: 5; y: 5;
	       Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "8ª intermitente" }
		   }
		   CheckBox { id: inter5; checked: true; x: 5; y: 25;
	       Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "5ª intermitente" }
		   }
		  }
		  // uníssono
	     ...
	     CheckBox { id: uniss; checked: true; x: 3; y: 5;
	       ...
	       CheckBox { id: unissIF; checked: true; x: 105; y: 0
		       Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 12; text: "Exceto Início/Final" }}
	   ...
	   Rectangle { id: item4; x: 270; y: 305; width: 235; height: 45; color: "#282828"; radius: 2
			...
			CheckBox { id: cruzaVozes; checked: true; x: 5; y: 3
		     Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "Cruzamento de vozes" }
		   }
	     ...
	     CheckBox { id: distancia; checked: true; x: 5; y: 3;
	       Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; color: "#e0dfc3"; font.pixelSize: 14; text: "Distância entre as vozes" }
   ...
   Rectangle { x: 2; y: 35; width: 508; height: 111;	color: "#003f87"; radius: 2
      ...
      CheckBox { id: cons; checked: true; x: 5; y: 5;
	    ...
	    CheckBox { id: maiorCons; checked: true; x: 5; y: 30;
	      Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12; text: "Se a maioria dos intervalos não for consonância imperfeita" } }
	  }
   }
 }
   ...
   Rectangle { x: 2; y: 35; width: 508; height: 111;	color: "#003f87"; radius: 2
     ...
     Rectangle { id: item6; x: 3; y: 3; width: 502; height: 105; color: "#b2b2b2"; radius: 2
	     ...
	     CheckBox { id: tF; checked: true; x: 5; y: 5;
	       Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12; text: "Tempos fortes, quando não for consonância" }
		  }

	  // tempos fracos
	     CheckBox { id: dissNP; checked: true; x: 5; y: 30;
	        Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12; text: "Dissonâncias, exceto se for Nota de passagem" }
		 	}
	   }
    }
  }
   ...
   Rectangle { x: 2; y: 35; width: 508; height: 111;	color: "#003f87"; radius: 2
    ...
    Rectangle { id: item8; x: 3; y: 3; width: 502; height: 105; color: "#b2b2b2"; radius: 2
	  ...
	  CheckBox { id: notaP; checked: true; x: 5; y: 25;
		Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12; text: "Exceto se for Nota de Passagem" }
	  }

	  CheckBox { id: cambi; checked: true; x: 5; y: 50;
		Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12; text: "Exceto se for Cambiata" }
	  }

	  CheckBox { id: borda; checked: true; x: 5; y: 75;
		Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12; text: "Exceto se for Bordadura" }
	  }
    }
   }
  }
   ...
   Rectangle { x: 2; y: 35; width: 508; height: 111;	color: "#003f87"; radius: 2
     Rectangle { id: item9; x: 3; y: 3; width: 502; height: 105; color: "#b2b2b2"; radius: 2
      ...
      CheckBox { id: susp4; checked: true; x: 5; y: 5;
		 Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12; text: "Dissonâncias, exceto se for Suspensão" }
	   }
	  }
   }
 }
   ...
   Rectangle { x: 2; y: 35; width: 508; height: 512;	color: "#5b5b5b"; radius: 2
    ...
    Rectangle { x: 3; y: 314; width: 502; height: 88; color: "#303030"; radius: 2
     CheckBox { id: varDir; checked: true; x: 5; y: 4;
      ...
      CheckBox { id: repeteNoutra; checked: true; anchors.left: parent.right; anchors.leftMargin: 5; anchors.verticalCenter: parent.verticalCenter;
 	  	Text { anchors.left: parent.right; anchors.leftMargin: 0; anchors.verticalCenter: parent.verticalCenter; font.pixelSize: 12;
...
function carregarNotas() {
  ...
  // ------------------ inicializa variáveis de dados
          ...
          if(processaTudo) { cursor.rewind(0); } else { cursor.rewind(1); }; // posiciona o cursor2 no início
        ...
        //   console.log(Object.keys(cursor.measure));
          ...
          // lê as informações da seleção (ou do documento inteiro, caso não haja seleção)
           ...
           while (segmento && (processaTudo || segmento.tick < posFinal)) {
            ...
            var uT = 1920 / denominador;  // unidade de tempo em ticks
            var tempo = ((segmento.tick - tickComp[compasso]) / uT) + 1;
            var voz = 0;
//console.log(segmento.tick, "-", tickComp[compasso], " ==> ", tempo);
...
console.log(int2, pMetric2, intervalos, contorno);
...
function criaResultado(verificados, x, voz, i, tipo, numAcordes, numVozes) {
 	...
 	var primAcorde = x - (numAcordes-1); //console.log(x, numAcordes, primAcorde);
